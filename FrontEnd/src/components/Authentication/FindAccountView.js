                ...
                <div className="container-fluid h-custom">
                    ...
                    <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        ...
                        <div className="divider d-flex align-items-center my-4 title">
                            <p className="text-center fw-bold mx-3 mb-0">Đặt lại mật khẩu</p>
                        </div>

                        <div className="form-outline mb-4">
                            <label className="form-label text" for="form3Example3">Email</label>
                        ...
                        <div className="d-flex justify-content-between text-lg-start mt-4 pt-2">
                            ...
                            type="button" 
                            className="active btn btn-primary btn-lg login-btn" 
                            >{loading ? <i class="fa-solid fa-spinner fa-spin"></i> : 'Tiếp theo'}</button>
                        </div>
                        </form>
                    </div>
                    </div>
